...
namespace ControlzEx {
    ...
    public abstract class PackIconBase<TKind> : PackIconBase {
        ...
        public static readonly DependencyProperty KindProperty
            = DependencyProperty.Register("Kind", typeof(TKind), typeof(PackIconBase<TKind>), new PropertyMetadata(default(TKind), KindPropertyChangedCallback));
        ...
        private static readonly DependencyProperty DataProperty
            = DependencyProperty.Register("Data), typeof(string), typeof(PackIconBase<TKind>), new PropertyMetadata(""));
        ...
        private static readonly DependencyPropertyKey DataPropertyKey
            = DependencyProperty.RegisterReadOnly("Data", typeof(string), typeof(PackIconBase<TKind>), new PropertyMetadata(""));
