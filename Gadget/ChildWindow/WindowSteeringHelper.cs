...
#pragma warning disable 618
        ...
        public static void HandleMouseLeftButtonDown(DependencyObject dependencyObject, MouseButtonEventArgs e, bool handleDragMove, bool handleStateChange) {
            ...
            if (handleDragMove
                ...
                NativeMethods.SendMessage(criticalHandle, (int)WM.SYSCOMMAND, (IntPtr)WM.MOUSEMOVE, IntPtr.Zero);
                NativeMethods.SendMessage(criticalHandle, (int)WM.LBUTTONUP, IntPtr.Zero, IntPtr.Zero);
