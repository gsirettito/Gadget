...
namespace Gadget {
    ...
    public partial class OnWheel : ChildWindow {
        private OnWheelEvent _event;
        static OnWheel() {
        }
        ...
        public OnWheel(OnWheelEvent _event)
            : base() {
            InitializeComponent();
            this.Loaded += OnClick_Loaded;
            this._event = _event;
        ...
        void OnClick_Loaded(object sender, RoutedEventArgs e) {
            ...
            _wheel_.Items.Clear();
            _wheel_.ItemsSource = Enum.GetNames(typeof(MouseWheelDirection));
            _wheel_.SelectedIndex = 0;
            ...
            if (_event != null) {
                ...
                _clicc_.SelectedValue = _event.WheelCount.ToString();
        ...
        private void okClick(object sender, RoutedEventArgs e) {
            ...
            if (_event == null) {
                ...
                new OnWheelEvent(
                    ...
                    (MouseWheelDirection)Enum.Parse(typeof(MouseWheelDirection), (string)_wheel_.SelectedItem),
                ...
                _event.WheelCount = _clicc_.SelectedIndex + 1;
